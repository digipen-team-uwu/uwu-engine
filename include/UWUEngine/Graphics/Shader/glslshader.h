...
public:
    ...
    void SetUniform(GLchar const* name, glm::uvec2& val)const;
    void SetUniform(GLchar const* name, GLboolean val) const;
    void SetUniform(GLchar const* name, GLint val) const;
    void SetUniform(GLchar const* name, GLfloat val) const;
    void SetUniform(GLchar const* name, GLfloat x, GLfloat y) const;
    void SetUniform(GLchar const* name, GLfloat x, GLfloat y, GLfloat z) const;
    void SetUniform(GLchar const* name, GLfloat x, GLfloat y, GLfloat z, GLfloat w) const;
    void SetUniform(GLchar const* name, glm::vec2& val) const;
    void SetUniform(GLchar const* name, glm::vec3& val) const;
    void SetUniform(GLchar const* name, glm::vec4& val) const;
    void SetUniform(GLchar const* name, glm::mat3& val) const;
    void SetUniform(GLchar const* name, const glm::mat4& val) const;
