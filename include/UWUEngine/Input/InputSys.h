...
private:
  ...
  using KeyCallbackHelper = CCallbackHelper<InputSys, KeyCallbackFn, KeyCallback, void, GLFWwindow*, int, int, int, int>;

  using MouseCallbackFn = void (InputSys::*)(GLFWwindow*, int, int, int);
  using MouseCallbackHelper = CCallbackHelper<InputSys, MouseCallbackFn, MouseCallback, void, GLFWwindow*, int, int, int>;

  using MousePosCallbackFn = void (InputSys::*)(GLFWwindow*, double, double);
  using MousePosCallbackHelper = CCallbackHelper<InputSys, MousePosCallbackFn, MousePosCallback, void, GLFWwindow*, double, double>;

  using ScrollWheelCallbackFn = void (InputSys::*)(GLFWwindow*, double, double);
  using ScrollWheelCallbackHelper = CCallbackHelper<InputSys, ScrollWheelCallbackFn, ScrollWheelCallback, void, GLFWwindow*, double, double>;

  using JoystickCallbackFn = void (InputSys::*)(int, int);
  using JoystickCallbackHelper = CCallbackHelper<InputSys, JoystickCallbackFn, JoystickCallback, void, int, int>;
};
