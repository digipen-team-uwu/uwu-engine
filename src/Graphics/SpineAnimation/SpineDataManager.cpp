...
std::unordered_map<std::string, SpineData> SpineDataManager::DataContainer;
...
void SpineDataManager::LoadData(const char* name, const char* atlasPath, const char* jsonPath, float scaleOffset)
{	
...
void SpineDataManager::LoadData(const char* name, SpineData& data)
{
	DataContainer.insert_or_assign(name, data);
}

SpineData& SpineDataManager::GetData(const char* dataName)
{
