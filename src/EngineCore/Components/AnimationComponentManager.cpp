...
glm::vec2 AnimationComp::indexToUvs(EntityID id, int index)
{
...
void AnimationComp::Serialize(std::ofstream& stream, EntityID id)
{
    // Check for an active animation component
    if (AnimationComp::IsActive(id))
    {
      auto& anim = animations[id];
        // Set boolalpha
